...
labs(x="",y="",title = "Forecast BTC For 13 Momths Next.",
subtitle = "From: Jan 2015 To Aug 2023 ")+
...
plot.subtitle = element_text(face = "bold.italic",colour = "black"),
plot.caption=element_text(hjust = 0,color="darkred",face = "bold.italic"))+
labs(x="",y="",title ="Forecast BTC For Year Next",
subtitle = "From Aug 2024 T0 Aug 2025",
caption = "Remove Prices Less Than 10K To Focus Model Chart .")
